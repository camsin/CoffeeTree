...
public class BebidasCalientesAdmin extends javax.swing.JFrame {
    ...
    public BebidasCalientesAdmin() {
     ...
     public BebidasCalientesAdmin(DefaultTableModel mod) {
            setUndecorated(true);
            initComponents();
            this.setSize(1086, 726);
            this.setLocationRelativeTo(null);
    ...
    private void btnRegresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegresarActionPerformed
        ...
        MenuInicioAdmin m = new MenuInicioAdmin(tabla.mod);
        m.setVisible(true);
    ...
    private void btnMokaBlancoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMokaBlancoActionPerformed
        ...
        JOptionPane.QUESTION_MESSAGE, 
        null,
        prod.toArray(), prod.get(0)); //De donde recupera los daos a mostrar
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BebidasCalientesAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BebidasCalientesAdmin().setVisible(true);
            }
        });
    }
