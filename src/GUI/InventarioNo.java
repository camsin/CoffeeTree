...
public class InventarioNo extends javax.swing.JFrame {
    int largo=0;
        ...
        if(!Character.isDigit(evt.getKeyChar()) && !Character.isISOControl(evt.getKeyChar()))
{
    ...
    private void btnResurtirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnResurtirActionPerformed
        ...
        Ingrediente in = (Ingrediente) cant_disp.get(w);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InventarioNo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InventarioNo().setVisible(true);
            }
        });
    }
